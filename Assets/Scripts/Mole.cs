...
public class Mole : MonoBehaviour
{
    ...
    private IEnumerator AnimateHammer(GameObject hammer)
    {
        ...
        //rayoPrefab.GetComponent<Animator>();
        ...
        float animationDuration = .3f; // Duration of the animation
    ...
    private void OnMouseDown()
    {
        ...
        //GameObject rayoInstance = Instantiate(rayoPrefab);
        GameObject hammerInstance = Instantiate(hammerPrefab, canvasTransform);
           StartCoroutine(AnimateHammer(hammerInstance));
    ...
    private void CreateNext()
    {
        ...
        else
        {
            ...
            //{
                ...
                spriteRenderer.sprite = moles[UnityEngine.Random.Range(0, moles.Length)];
                lives = 1;
            //}
